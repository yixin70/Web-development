My Project for Web Development with Angular/NODEJS.
...
For the game, you can set preferences for number of UFOs and time,  both affecting your final score, which can be saved if you are logged after the time runs out.
